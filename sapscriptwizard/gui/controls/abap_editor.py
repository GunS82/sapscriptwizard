"""Utilities for the GuiTextEditor control in ABAP editor."""
...
class GuiAbapEditor:
    """Expose a pythonic API for ABAP editor control."""
    ...
    def get_all_text(self) -> str:
        try:
            ...
            raise SapError(
                ...
                "ABAP editor does not expose Text",
                str(exc),
            ) from exc
    ...
    def set_all_text(self, text: str) -> None:
        try:
            ...
            raise SapError(
                ErrorCode.DISABLED,
                "Failed to write ABAP editor text",
                str(exc),
            ) from exc
